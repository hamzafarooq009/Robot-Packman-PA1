...
######################################################################
    ...
    def generate_candidate_sols(self, n): 
        ...
        returns: (list of n random 56 bit ConstBitStreams) 
        ...
        '''
        # constbitstream: This adds methods and properties to allow the bits to be treated as a 
        # stream of bits, with a bit position and reading/parsing methods.
        ...
        # binary_conv_string = '{0:014b}'.format(rand_num)
        # s = ConstBitStream(bString)
        # print(s.pos)
        for i in range (1):
            for j in range(4):
                rand_num = self.random_num()
                binary_conv_string = '{0:014b}'.format(rand_num) #giving random_num in binary
                bString = bString + binary_conv_string
            # print(bString)
            s = ConstBitStream(bString)
            individual_list.append(s)
            # s.pos = -56
            # print("s.pos : ", s.pos)
            # final_result = (final_result.bitpos + 1)
            
            bString = "" #empty the string
            
        return individual_list
        # return s.pos
        # print("testing random number ", testing_random)    
        
        # return testing_random
        # for i in range (n):
        #each individual in the population is 56 bits Constbitstream
        # **** End of Your Code **** # 
...
genObj = GeneticAlgorithm(5,56,True)
print(genObj.generate_candidate_sols(5))
